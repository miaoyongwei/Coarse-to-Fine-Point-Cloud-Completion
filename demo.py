...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default='demo_data/bunny_break.pcd')
    parser.add_argument('--model_type', default='concat_4_1')
    parser.add_argument('--checkpoint', default='log/concat_1564/model-300000')
    ...
    f = open('demo_data/bunny_break_ours.pcd', 'a')
