...
def fileSave(step,complete):
    ...
    for k in range(4):
        f = open('data/result5/bookcase'+str(k)+'_break'+str(step)+'.pcd', 'a')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', default='log/pcn_cd_withoutfolding')
    parser.add_argument('--model_type', default='pcn_cd_withoutfolding')
