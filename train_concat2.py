...
class WassersteinGAN(object):
    ...
    def __init__(self,g_net,inputs,gt,alpha):
        ...
        #CD值loss的东东
        self.loss_fine = 0.2 * chamfer(self.x_mis, self.x) + 0.8 * chamfer(self.x_concat, self.x)
...
def fileSave(step,complete):
    ...
    for k in range(4):
        f = open('data/result6/bookcase'+str(k)+'_break'+str(step)+'.pcd', 'a')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', default='log/2>1_ch')
