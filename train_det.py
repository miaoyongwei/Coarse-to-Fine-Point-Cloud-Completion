...
def fileSave(step,complete):
    ...
    for k in range(4):
        f = open('data/result9/bookcase'+str(k)+'_break'+str(step)+'.pcd', 'a')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lmdb_train', default='data/detail/detail.lmdb')
    parser.add_argument('--log_dir', default='log/detail_1')
    parser.add_argument('--model_type', default='detail_1')
    parser.add_argument('--batch_size', type=int, default=4)
    parser.add_argument('--num_input_points', type=int, default=1536)
