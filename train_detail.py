...
class WassersteinGAN(object):
    ...
    def __init__(self,g_net,inputs,gt,alpha):
        ...
        #CD值loss的东东
        self.loss_fine = 0.6 * chamfer(self.x_mis, self.x) + 0.4 * chamfer(self.x_concat, self.x)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', default='log/detail')
    parser.add_argument('--model_type', default='detail')
