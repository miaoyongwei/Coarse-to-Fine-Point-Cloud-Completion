...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default='demo_data/lamp/1a963b28c5520cc737b2bb75885cfc44_break.pcd')
    parser.add_argument('--model_type', default='concat_2048')
    parser.add_argument('--checkpoint', default='log/0807/model-100000')
    ...
    g_shape, fine1, fine2 = g_net(partial)
    ...
    f = open('demo_data/lamp/1a963b28c5520cc737b2bb75885cfc44_ours.pcd', 'a')
