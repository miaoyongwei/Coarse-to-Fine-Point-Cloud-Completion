...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default='demo_data/saum_data1/add/miss_saum1/bench_0021_break.pcd')
    parser.add_argument('--model_type', default='crn')
    parser.add_argument('--checkpoint', default='log/crn1/model-300000')
    ...
    f = open('demo_data/saum_data1/add/miss_saum1/bench_0021_break_crn.pcd', 'a')
