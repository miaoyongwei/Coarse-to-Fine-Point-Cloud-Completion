...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', default='log/atlas2048/model-100000')
    ...
    f = open('demo_data/saum_data/add/saum3/airplane_6_break_atlas.pcd', 'a')
