...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default='demo_data/saum_data/add/saum3/airplane_6_break_concat.pcd')
    ...
    f = open('demo_data/saum_data/add/saum3/airplane_6_break_concat_2048.pcd', 'a')
