...
class WassersteinGAN(object):
    ...
    def __init__(self,g_net,inputs,gt):
        ...
        #CD值loss的东东
        self.loss_fine = chamfer(self.x_, self.x)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', default='log/pcn_detail')
    parser.add_argument('--model_type', default='pcn2048')
