...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default='data/detail_mis/dragon_break.pcd')
    parser.add_argument('--model_type', default='detail')
    parser.add_argument('--checkpoint', default='log/detail/model-100000')
    ...
    f = open('demo_data/stanford/dragon (1) (1)_break_ours9.pcd', 'a')
