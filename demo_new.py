...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default='demo_data/ch_weight/airplane_0218_break2.pcd')
    parser.add_argument('--model_type', default='new')
    parser.add_argument('--checkpoint', default='log/new/model-100000')
    ...
    f = open('demo_data/ch_weight/airplane_0218_break2_new.pcd', 'a')
