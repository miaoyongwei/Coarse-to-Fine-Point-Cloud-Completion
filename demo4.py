...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default='demo_data/fig6_mis/airplane_0111_break2.pcd')
    parser.add_argument('--model_type', default='capsule1')
    parser.add_argument('--checkpoint', default='log/capsule1/model-40000')
    ...
    f = open('demo_data/fig6_mis/airplane_0111_break2_capsule.pcd', 'a')
