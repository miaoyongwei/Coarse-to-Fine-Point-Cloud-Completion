...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', default='pcn_cd_folding')
    parser.add_argument('--checkpoint', default='log/folding/model-300000')
    ...
    f = open('demo_data/saum_data1/add/miss_saum1/bench_0016-1_break_fold.pcd', 'a')
