...
class WassersteinGAN(object):
    ...
    def __init__(self,g_net,inputs,gt,alpha):
        ...
        #CD值loss的东东
        self.loss_fine = 0.3*(chamfer(self.x_, self.x) + earth_mover(self.x_, self.x)) + 0.7*(chamfer(self.x__, self.x) + earth_mover(self.x__, self.x))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', default='log/caps2')
    parser.add_argument('--model_type', default='caps2')
