...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default='demo_data/saum_data1/add/miss_saum1/bench_0016-1_break.pcd')
    parser.add_argument('--model_type', default='atlas')
    parser.add_argument('--checkpoint', default='log/atlas/model-200000')
    ...
    f = open('demo_data/saum_data1/add/miss_saum1/bench_0016-1_break_atals.pcd', 'a')
