...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', default='log/concat_gauss/model-130000')
    ...
    f = open('demo_data/fig66/range_hood_0038_break2_net1.pcd', 'a')
