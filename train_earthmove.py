...
def fileSave(step,complete):
    ...
    for k in range(4):
        f = open('data/result12/bookcase'+str(k)+'_break'+str(step)+'.pcd', 'a')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', default='log/folding_detail')
    parser.add_argument('--model_type', default='folding2048')
