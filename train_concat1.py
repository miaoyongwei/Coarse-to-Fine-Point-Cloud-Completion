...
class WassersteinGAN(object):
    ...
    def __init__(self,g_net,inputs,gt,alpha):
        ...
        #生成模型
        self.x_mis, self.x_, self.x_concat = self.g_net(self.z)
...
def fileSave(step,complete):
    ...
    for k in range(4):
        f = open('data/result/bookcase'+str(k)+'_break'+str(step)+'.pcd', 'a')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', default='log/1231')
    parser.add_argument('--model_type', default='concat_2048')
