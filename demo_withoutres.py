...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default='demo_data/fig6_mis/vase_0147_break2.pcd')
    parser.add_argument('--model_type', default='pcn_cd_earthmove')
    parser.add_argument('--checkpoint', default='log/pcn_cd_earthmove/model-300000')
    ...
    f = open('demo_data/fig6_mis/vase_0147_break2_withoutres.pcd', 'a')
