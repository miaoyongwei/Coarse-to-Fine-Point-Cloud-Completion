...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default='demo_data/saum_data/add/saum3/airplane_8_break.pcd')
    parser.add_argument('--model_type', default='saum')
    parser.add_argument('--checkpoint', default='log/saum3/model-300000')
    ...
    f = open('demo_data/saum_data/add/saum3/airplane_8_break_saum.pcd', 'a')
    ...
    f = open('demo_data/saum_data/add/saum3/airplane_8_break_en_de.pcd', 'a')
    f.writelines("# .PCD v0.7 - Point Cloud Data file format")
    f.writelines("\n")
    f.writelines("VERSION 0.7")
    f.writelines("\n")
    ...
    f = open('demo_data/saum_data/add/saum3/airplane_8_break_concat.pcd', 'a')
    f.writelines("# .PCD v0.7 - Point Cloud Data file format")
    f.writelines("\n")
    f.writelines("VERSION 0.7")
    f.writelines("\n")
