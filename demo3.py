...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default='demo_data/watercraft/1b2e790b7c57fc5d2a08194fd3f4120d.pcd')
    parser.add_argument('--model_type', default='folding2048')
    parser.add_argument('--checkpoint', default='log/folding2048/model-300000')
    ...
    f = open('demo_data/watercraft/1b2e790b7c57fc5d2a08194fd3f4120d_net4.pcd', 'a')
